...
1. [Proč bodyshop není „jen další projekt“](#proc-bodyshop-neni-jen-dalsi-projekt)
2. [Jak vypadá skutečný hodnotový řetězec peněz](#jak-vypada-skutecny-hodnotovy-retezec-penez)
3. [Splatnost 30 dní: proč to bolí víc, než se zdá](#splatnost-30-dni-proc-to-boli-vic-nez-se-zda)
4. [Faktoring: co je mýtus a co realita](#faktoring-co-je-mytus-a-co-realita)
5. [Smluvní realita: co bývá problémové](#smluvni-realita-co-byva-problemove)
6. [Risk scoring nabídky: jednoduchý model před podpisem](#risk-scoring-nabidky-jednoduchy-model-pred-podpisem)
7. [Cashflow systém pro přežití OSVČ](#cashflow-system-pro-preziti-osvc)
...
1. Kontraktor dodá práci + timesheet.
2. Schválení běží na straně klienta.
3. Prostředník (agentura/vendor) fakturuje korporát a drží si svoji marži.
4. Kontraktor fakturuje prostředníkovi podle své smlouvy.
5. Prostředník platí kontraktorovi (někdy až po inkasu od klienta, nebo se zpožděním kvůli internímu procesu).
...
1. Opakované zpoždění plateb bez transparentního důvodu.
2. Chaotické nebo neexistující schvalování výkazů.
3. Tlak na neformální změny podmínek bez dodatku.
4. Snahy přenést na kontraktora rizika, která nemůže ovlivnit.
5. Věty typu „když se to nelíbí, je za ním fronta“ kombinované s finanční nespolehlivostí.
...
V praxi tuto část velmi dobře pokryjí nástroje typu [Fakturoid](https://www.fakturoid.cz/) nebo jiné fakturační systémy. Obvykle umí šablony faktur, automatické hlídání splatností, upomínky i základní přehled cashflow, takže výrazně snižují administrativu.
